...
class pizarra
{
    ...
    public void enlistar( int numeroDeAgente, int Alto, int Bajo)
    {
        l.add( new elementoPizarra(numeroDeAgente, Alto, Bajo) );
    }
    
    public elementoPizarra desenlistar(int AgenteId)
    {
        elementoPizarra elem = (elementoPizarra) l.get(0);
        
        if( elem.getNumeroDeAgente() == AgenteId )
        {
            elem = (elementoPizarra) l.get(1);
            l.remove(1);
        }
        else
            l.remove(0);
...
class elementoPizarra
{
    private final int NumeroDeAgente;
    ...
    public elementoPizarra(int NumeroDeAgente, int Alto, int Bajo) {
